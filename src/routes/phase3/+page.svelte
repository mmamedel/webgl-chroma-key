<script lang="ts">
  ...
  import fragShader from "$lib/shaders/phase3.frag?raw";
...
<main>
  <div class="header">
    <h1>Phase 3: Output Modes</h1>
    <div class="nav-links">
      <a href="/phase2" class="back-link">← Phase 2</a>
      <a href="/phase4" class="next-link">Phase 4: Spill Suppression →</a>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="controls-panel">
      ...
      <div class="info-box">
        <h3>✅ Phase 3: Output Modes</h3>
        <ul>
          <li>
            <strong>Status Mode</strong> - Color-coded visualization of matte quality
          </li>
          <li>
            <strong>Visual Feedback</strong> - Green (transparent), Red (partial),
            White (opaque)
          </li>
          <li>Helps identify problem areas and edge quality</li>
        </ul>
        <p class="next">
          <strong>From Phase 1 & 2:</strong> All matte controls (Highlight, Shadow,
          Pedestal, Transparency, Tolerance)
        </p>
        <p class="next">
          <strong>Next:</strong> Phase 4 adds configurable spill suppression to fix
          desaturation
        </p>
      </div>
    </div>
