<script lang="ts">
  ...
  import fragShader from "$lib/shaders/phase1.frag?raw";
...
<main>
  <div class="header">
    <h1>Phase 1: Core Parameter System</h1>
    <div class="nav-links">
      <a href="/" class="back-link">← Original Demo</a>
      <a href="/phase2" class="next-link">Phase 2: Matte Generation →</a>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="controls-panel">
      ...
      <div class="info-box">
        ...
        <ul>
          <li>User-selectable key color</li>
          <li>Adjustable Transparency parameter</li>
          <li>Adjustable Tolerance parameter</li>
          <li>Preset system (Default/Aggressive/Custom)</li>
          <li>Output modes (Composite/Alpha Channel)</li>
        </ul>
        <p class="next">
          <strong>Next:</strong> Phase 2 will add Highlight, Shadow, and Pedestal
          controls
        </p>
      </div>
    </div>
