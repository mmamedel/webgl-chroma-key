<script lang="ts">
  ...
  import fragShader from "$lib/shaders/phase2.frag?raw";
...
<main>
  <div class="header">
    <h1>Phase 2: Matte Generation</h1>
    <div class="nav-links">
      <a href="/phase1" class="back-link">← Phase 1</a>
      <a href="/phase3" class="next-link">Phase 3: Output Modes →</a>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="controls-panel">
      ...
      <div class="info-box">
        <h3>✅ Phase 2: Matte Generation</h3>
        <ul>
          <li>
            <strong>Highlight</strong> - Luminance-based control for bright areas
          </li>
          <li>
            <strong>Shadow</strong> - Luminance-based control for dark areas
          </li>
          <li><strong>Pedestal</strong> - Shifts entire alpha range</li>
          <li>Improved alpha falloff with luminance awareness</li>
        </ul>
        <p class="next">
          <strong>From Phase 1:</strong> Key color, Transparency, Tolerance, Presets,
          Output modes
        </p>
        <p class="next">
          <strong>Next:</strong> Phase 3 will add Status mode, Phase 4 will add configurable
          spill suppression
        </p>
      </div>
    </div>
